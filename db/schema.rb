...
ActiveRecord::Schema.define(version: 20_191_214_010_412) do
  ...
  create_table 'indexing_batches_pages', id: false, force: :cascade do |t|
    ...
    t.index %w[indexing_batch_id page_id], name: 'index_indexing_batches_pages_on_indexing_batch_id_and_page_id'
    t.index %w[page_id indexing_batch_id], name: 'index_indexing_batches_pages_on_page_id_and_indexing_batch_id'
  end
